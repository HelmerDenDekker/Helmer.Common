...
public class Result
{
	...
	public static Result Ok =>
        new(new List<string> { "The request succeeded and the requested information is in the response" },
            HttpStatusCode.OK);
	...
	public static Result BadRequest =>
        new(new List<string> { "The request cannot be processed by the code due to a validation error" },
	...
	public static Result UnAuthorized =>
        new(new List<string> { "The request cannot be processed by the code, no authorization" },
	...
	/// </summary>
	public static Result NotFound => new(new List<string> { "The resource cannot be found by the code" },
	...
	/// </summary>
	public static Result InsecureUrl =>
        new(
            new List<string>
                { "The request cannot be processed by the server, due to an insecure url address being used." },
	...
	public static Result InternalServerError =>
        new(new List<string> { "The request cannot be processed by the server. A generic error has occured." },
	...
	public static Result NotImplemented =>
        new(new List<string> { "The request cannot be processed by the server. This functionality is not implemented" },
