...
namespace Helmer.Shared.Common
{
    ...
    public class Result
    {
		...
		{
			bool isSuccess = statusCode is HttpStatusCode.OK or HttpStatusCode.NoContent or HttpStatusCode.Created;
			IsSuccess = isSuccess;
			Messages = messages;
        ...
        /// </summary>
        public static Result NotImplemented => new(new List<string> { "The request cannot be processed by the server. This functionality is not implemented" }, HttpStatusCode.NotImplemented);
    }
}
